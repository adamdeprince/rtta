...
`AverageDirectionalMovementIndexRating` is part of Wilder's directional-movement system. The update compares today's high/low extension with the previous bar, smooths directional movement and true range, and then reports either a directional component, a normalized directional imbalance, or an additional Wilder-smoothed trend-strength rating.
...
[`AverageDirectionalMovementIndex`](average-directional-movement-index.md), [`Delay`](delay.md)
