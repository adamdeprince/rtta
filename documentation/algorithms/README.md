...
| [`Ichimoku`](ichimoku.md) | Ichimoku conversion, base, leading spans, lagging span, and displaced cloud spans. |
...
| [`SqrtImpactFlowSignal`](sqrt-impact-flow-signal.md) | Square-root impact residual flow: continuation of unused impact budget and reversion of overshoot, with optional VWAP alignment (Massive/Polygon). |
